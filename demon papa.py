...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '8112431515:AAHRyBJGLlAOnXeUtuf9pZ2zM90BppoJphc'  # Replace with your bot token
OWNER_USERNAME = "GAURAV_BHAI1"  # Replace with your Telegram username (without @)
DEFAULT_GROUP_ID = -1001985887035  # Default group ID
